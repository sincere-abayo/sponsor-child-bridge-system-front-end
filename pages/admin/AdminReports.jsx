      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Overview of sponsorship activity, financials, and system stats</p>
          </div>
          <button
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="text-2xl font-bold text-green-700">{stats?.totalSponsorships ?? '--'}</div>
              </div>
              <div className="bg-white rounded-lg shadow-sm border p-6">
                <div className="text-sm text-gray-500 mb-1">Active Sponsorships</div>
                <div className="text-2xl font-bold text-green-700">{stats?.activeSponsorships ?? '--'}</div>
              </div>
            </div>
            {/* Financial Summary */}
